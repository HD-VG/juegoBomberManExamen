...
private:
	...
	Items* items;
	SueloCespedCongelado* sueloCespedCongelado;
	int posicionTileX;
	int posicionTileY;
...
public:
	...
	SueloCespedCongelado* getSueloCespedCongelado() { return sueloCespedCongelado; }
	...
	void setItems(Items* _items) { items = _items; }
	void setSueloCespedCongelado(SueloCespedCongelado* _sueloCespedCongelado) { sueloCespedCongelado = _sueloCespedCongelado; }
