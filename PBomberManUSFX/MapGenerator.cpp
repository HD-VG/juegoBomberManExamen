...
bool MapGenerator::crearObjetosJuego(string _path)
{
	...
	Texture* texturaItems;
	texturaItems = new Texture();
	Texture* texturaSueloCespetCongelado;
	texturaSueloCespetCongelado = new Texture();
	...
	texturaItems->loadFromImage("resources/Items_botita.jpg");
	texturaSueloCespetCongelado->loadFromImage("resources/suelo_cesped_congelado.jpg");
			...
			if (chars[i] != ' ') {
				...
				case '2':
					...
					/*case 'B':
						...
						break;*/
				/*case '3':
					objetoNuevo = new Items(texturaItems, tileNuevo);
					break;*/
				case '4' :
					objetoNuevo = new SueloCespedCongelado(texturaSueloCespetCongelado, tileNuevo);
